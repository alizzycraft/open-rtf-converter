...
- Nested-table border refinement (2026-08-02): nested cell border selectors and bounded border styles/widths/spacing/colors are retained in the safe model and rendered in the inner grid; borderless nested tables retain the light fallback grid. Full split all-feature verification remains green.
